...
--
-- Database: devwebcamp
-- Generation Time: 2023-08-15 12:35:43.3630
-- -------------------------------------------------------------
...
(3, 'Tailwind y Figma', 'Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec sodales condimentum magna fringilla egestas. In non pellentesque magna, at mollis velit. Morbi nec dapibus diam. Phasellus ante neque, blandit eget tortor a, cursus molestie turpis. Aenean placerat aliquet nibh, et interdum ipsum finibus at. Nulla sit amet faucibus leo, vel blandit urna. Curabitur dictum euismod sem, eget euismod magna pulvinar et. Nam semper aliquet nunc eu ornare. ', 47, 1, 1, 2, 3),
...
(16, 'GraphQL y Flutter - Gran Performance para Android y iOS', 'Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec sodales condimentum magna fringilla egestas. In non pellentesque magna, at mollis velit. Morbi nec dapibus diam. Phasellus ante neque, blandit eget tortor a, cursus molestie turpis. Aenean placerat aliquet nibh, et interdum ipsum finibus at. Nulla sit amet faucibus leo, vel blandit urna. Curabitur dictum euismod sem, eget euismod magna pulvinar et. Nam semper aliquet nunc eu ornare. ', 27, 1, 1, 5, 15),
...
(18, ' Nico', 'Fraga', 'Buenos Aires', 'Argentina', '2bc1ab8da1876259a4d6aae127ee49b4', 'PHP,Laravel,Flutter,React Native', '{\"facebook\":\"https://facebook.com/C%C3%B3digo-Con-Juan-103341632130628\",\"twitter\":\"https://twitter.com/codigoconjuan\",\"youtube\":\"https://youtube.com/codigoconjuan\",\"instagram\":\"\",\"tiktok\":\"\",\"github\":\"\"}');
...
(1, 1, '2AN08781CJ472735H', '1a1e20e6', 4, 8),
(6, 2, '66970375H57913456', 'ac41a06e', 5, 1),
(7, 3, '', '2a897ed9', 6, 1);

INSERT INTO `usuarios` (`id`, `nombre`, `apellido`, `email`, `password`, `confirmado`, `token`, `admin`) VALUES
(2, ' Remy', 'Patgher', 'remypatgher@gmail.com', '$2y$10$/tJG0KGoljKrz2YAeBxsoujlbFMjBF99vjOByx7AuWoi.IZvta5Cu', 1, '', 1),
(4, ' Carlos', 'Hernandez', 'correo@correo.com', '$2y$10$TrHlWs1zfYxGG4gP1vnEn.BThdxTgSDN/ATrRE/lLBjR/TYuZXBam', 1, '', 0),
(5, ' Jan', 'Aguilar', 'correo2@correo.com', '$2y$10$3vyvzZo3XOx52W9auRoYy.3H6hneo5oYlhn8cBbHqz3jzPSLjDis6', 1, '', 0),
(6, ' Mayuli', 'Aguilar', 'correo3@correo.com', '$2y$10$C9mx3N1dvOkJWvwj9aYJP.DWXuasdxDA4Tac7rDnDNOHOl6BTQFB2', 1, '', 0);
