...
<section class="resumen">
    <div class="resumen__grid">
        ...
        <div class="resumen__bloque" <?php aos_animacion(); ?>>
            <p class="resumen__texto resumen__texto--numero">300</p>
...
<section class="speakers">
    ...
    <p class="speakers__descripcion">Conocer a nuestros expertos de DevWebCamp</p>
...
<section class="boletos">
    ...
    <div class="boletos__grid">
        <div class="boleto boleto--presencial" <?php aos_animacion(); ?>>
            ...
            <p class="boleto__plan">Presecial</p>
