<main class="registro">
    ...
    <div class="paquetes__grid">
        ...
        <div class="paquete">
            ...
            <ul class="paquete__lista">
                <li class="paquete__elemento">Acceso Vitual a DevWebCamp</li>
                <li class="paquete__elemento">Paso por 2 días</li>
...
<script src="https://www.paypal.com/sdk/js?client-id=AYCFhf3u_nsxcyJ6qjcgDdaLkTcy_NGjxxEnlT29WMRVQeAmg6Iqzj8_g8KbABaFYtFQPE8_IH05Z0kO&enable-funding=venmo&currency=USD" data-sdk-integration-source="button-factory"></script>
