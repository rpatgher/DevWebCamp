    ...
    <h2 class="conferencias__heading"><?php echo $titulo; ?></h2>
    <p class="conferencias__descripcion">Elige hasta 5 eventos para asistir de forma presencial.</p>
    ...
    <aside class="registro">
        ...
        <div class="registro__regalo">
            ...
            <select id="regalo" class="registro__select">
                <option selected disabled value="">-- Seleccione tu regalo --</option>
